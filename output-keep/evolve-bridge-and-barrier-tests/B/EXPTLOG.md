...
```
gawk '/INFO: isl/ {print $3","$5","$11}' out-evolve-bridge-and-barrier-tests-B.txt > out-evolve-bridge-and-barrier-tests-B.csv
```

Now plot this data:

```
~/polybee/tools/plot_fitness_islands.py --type 1 out-evolve-bridge-and-barrier-tests-B.csv
```
